...
| `IssueCommentEvent` / `created`                                                        | Comments / `issue-comment`           | `payload.issue.number`, `payload.comment.id`, canonical issue or pull-request source URL                                   | `payload.comment.html_url`, issue or pull-request title. Comment body is never retained.                                     |
